...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 14, 2020 at 07:08 PM
...
('PMaths1AL', 'Pure Mathematics', 'AL', 'EmpT001'),
('Sinhala1AL', 'Sinhala', 'AL', 'EmpT002');
...
('S2020AL0005', 'Nipuni', 'Warakagoda', '', '0719891273', 'Kandy', '1995-12-07', 'nipu@gmail.com'),
('S2020AL0010', 'Malathee', 'Nethmina', '', '0719891273', 'Kandy', '1997-11-27', 'malathee@gmail.com');
...
('S2020AL0001', 'NULL'),
('S2020AL0001', 'PMaths1AL'),
('S2020AL0002', 'NULL'),
('S2020AL0002', 'PMaths1AL'),
('S2020AL0004', 'PMaths1AL'),
('S2020AL0004', 'Sinhala1AL'),
('S2020AL0005', 'PMaths1AL'),
('S2020AL0005', 'Sinhala1AL'),
('S2020AL0010', 'pick1'),
('S2020AL0010', 'pick2'),
('S2020AL0010', 'pick3'),
('S2020AL0010', 'PMaths1AL');
...
('EmpT001', 'Sugath Darshana', '', '0710654821', 'sugath@gmail.com'),
('EmpT002', 'Lasitha Pathirana', '', '0778496231', 'lasitha@gmail.com');
...
('1', '1', 'admin', 'admin'),
('EmpT001', 'Teacher', 'Sugath Darshana', '1234'),
('EmpT002', 'Teacher', 'Lasitha Pathirana', '1234'),
('S2020AL0001', 'Student', 'Lalinda Nawinjith', '1234'),
('S2020AL0002', 'Student', 'Kavini Nanayakkara', '1234'),
('S2020AL0003', 'Student', 'Minura Pabasara', '1234'),
('S2020AL0004', 'Student', 'Hansika Muthunayake', '1234'),
('S2020AL0005', 'Student', 'Nipuni Warakagoda', '1234'),
('S2020AL0006', 'Student', 'Shehani Fernando', '1234'),
('S2020AL0007', 'Student', 'Nethmi Vihara', '1234'),
('S2020AL0008', 'Student', 'sajini Vihara', '1234'),
('S2020AL0009', 'Student', 'Malaka Nethmina', '1234'),
('S2020AL0010', 'Student', 'Malathee Nethmina', '1234'),
('Student2', 'Student', 'Banuka_H', '1234');
...
ALTER TABLE `student_learn`
  ADD PRIMARY KEY (`studentid_fk`,`courseid_fk`) USING BTREE;

--
-- Indexes for table `student_parent`
--
ALTER TABLE `student_parent`
  ADD PRIMARY KEY (`studentid_fk`),

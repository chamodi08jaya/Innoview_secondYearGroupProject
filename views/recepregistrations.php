...
<head>
    ...
    <title>Receptionistt Registration</title>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12 forms-right-icons">
                    <div class="section-heading">
                        <h2><span>Sign Up Receptionists  With Us</span></h2>
                        <br/>
                        <p class="subheading">Register all the receptionists to our system.
                        </p>
                    </div>
                        ...
                        <div class="form-bottom">
                            <form role="form" action="" class="login-form">
                                                ...
                                                <div class="input-group form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="First Name" aria-describedby="basic-addon1" required="required">
                                                </div>
                                                <div class="input-group form-group">
                                                    <span class="input-group-addon" id="basic-addon1"><i class="fa fa-user"></i></span>
                                                ...
                                                <!-- <div class="input-group form-group">
                                                    ...
                                                    <!-- <input class="input--style-3 js-datepicker" type="text" placeholder="Birthdate" name="birthday" aria-describedby="basic-addon1" required="required">
                                                     -->
                                                <!-- </div> -->
                                                <!-- <div class="input-group form-group">
                                                    <span class="input-group-addon" id="basic-addon1"><i class="fa fa-user"></i></span>
                                                ...
                                                <!-- <div class="input-group form-group">
                                                        <span class="input-group-addon" id="basic-addon1"><i class="fa fa-user"></i></span>
                                                        <input type="date" class="form-control" placeholder="Date of Birthday" aria-describedby="basic-addon1" required="required">
                                                    </div> -->
                                                    <div class="input-group form-group">
                                                            <span class="input-group-addon" id="basic-addon1"><i class="fa fa-user"></i></span>
                                                            <!-- <input type="date" class="form-control" placeholder="Date of Birthday" aria-describedby="basic-addon1" required="required">
                                                ...
                                                <!-- <div class="input-group form-group">
                                                    <span class="input-group-addon" id="basic-addon1"><i class="fa fa-user"></i></span>
                                                    <input type="text" class="form-control" placeholder="Parents/ Guardian First Name" aria-describedby="basic-addon1" required="required">
                                                </div> -->
                                                <!-- <div class="input-group form-group">
                                                    <span class="input-group-addon" id="basic-addon1"><i class="fa fa-user"></i></span>
                                                    <input type="text" class="form-control" placeholder="Parents/ Guardian Last Name" aria-describedby="basic-addon1" required="required">
                                                </div> -->
                                                <div class="input-group form-group">
                                                    <span class="input-group-addon" id="basic-addon1"><i class="fa fa-envelope"></i></span>

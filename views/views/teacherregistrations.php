      ...
      <div class="templatemo-sidebar">
        ...
        <nav class="templatemo-left-nav">          
          <ul>
            ...
            <li><a href="<?php echo base_url();?>index.php/Welcome/teacherregistrations"><i class="fa fa-users fa-fw"></i>Receptionist Registration</a></li>
                ...
                <!-- <div class="section-heading"> -->
                    ...
                    <div class="form-box">
                        ...
                        <div class="input-group form-group">
                                                ...
                                                <div class="input-group form-group">
                                                    <span class="input-group-addon" id="basic-addon1"><i class="fa fa-user"></i></span>
                                                    <input type="text" class="form-control" id="user_name" placeholder="user_name" aria-describedby="basic-addon1" required="required">
                                                </div>
                                                <div class="input-group form-group">
                                                    <span class="input-group-addon" id="basic-addon1"><i class="fa fa-user"></i></span>
                                                    <input type="text" class="form-control" id="subject" placeholder="ssubject" aria-describedby="basic-addon1" required="required">
                                                </div>
                                                <div class="input-group form-group">
                                                    <span class="input-group-addon" id="basic-addon1"><i class="fa fa-user"></i></span>
                                                    <input type="text" class="form-control" id="grade" placeholder="grade" aria-describedby="basic-addon1" required="required">
                                                </div>
                                                <div class="input-group form-group">
                                                    <span class="input-group-addon" id="basic-addon1"><i class="fa fa-user"></i></span>

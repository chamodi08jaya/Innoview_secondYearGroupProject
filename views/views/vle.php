    ...
    <div class="templatemo-flex-row">
      <div class="templatemo-sidebar">
        ...
        <nav class="templatemo-left-nav">          
          <ul>
            <li><a href="<?php echo base_url();?>index.php/Welcome/student"><i class="fa fa-home fa-fw"></i>Dashboard</a></li>
            ...
            <li><a href="#" class="active"><i class="fa fa-users fa-fw"></i>VLE</a></li>
          ...
          <div class="row">
            <nav class="templatemo-top-nav col-lg-12 col-md-12">
              <ul class="text-uppercase">
                <li><a href="">View Tutes</a></li>
                <li><a href="">Upload Answers</a></li>
                ...
                <li><a href="" class="active">UPLOAD ANSWERS</a></li><br><br>
                
            

        <!--Answers upload section-->

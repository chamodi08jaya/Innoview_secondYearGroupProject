				...
				<span class="icon-bar"></span>
                    ...
                    <div id="navbar" class="collapse navbar-collapse navbar-right">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a href="application\views\about.html">About Us</a></li>
                            ...
                            <li><a href="registration.html">Sign Out</a></li>
    ...
    <div id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="item active">
                ...
                <div class="fill" style="background-image:url('assets1/img/banner-slide-1.jpg');"></div>
                <div class="carousel-caption slide-up">
                    <h1 class="banner_heading">Providing The <span>best </span>education</h1>
                    <!-- <p class="banner_txt"> instructior eiut vix denique fierentis ea saperet inimicu utqui dolor oratio mnesarchum.</p>
                    -->
                    <div class="slider_btn">
                        <button type="button" class="btn btn-default slide"><a href="registration.html">Edit Profile</a></button>
                        <button type="button" class="btn btn-default slide"><a href="registration.html">Notifications</a></button>
                        <button type="button" class="btn btn-default slide"><a href="registration.html">Virtual Learning Environment </a></button>
                        <button type="button" class="btn btn-default slide"><a href="registration.html">Payment</a></button>
                        <button type="button" class="btn btn-default slide"><a href="registration.html">Attendence</a></button>

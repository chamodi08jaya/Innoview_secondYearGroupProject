...
<html>
  <head>
    ...
    <title>Sothern Educational Institute</title>
    ...
    <!-- orion icons-->
    <link rel="stylesheet" href="assets1/css/orionicons.css">
    <!-- theme stylesheet-->
    ...
    <!-- Favicon-->
    <link rel="shortcut icon" href="assets1/img/favicon.png?3">
  ...
  <body>
    <!-- navbar-->
    <header class="header">
      <nav class="navbar navbar-expand-lg px-4 py-2 bg-white shadow"><a href="#" class="sidebar-toggler text-gray-500 mr-4 mr-lg-5 lead"><i class="fas fa-align-left"></i></a><a href="index.html" class="navbar-brand font-weight-bold text-uppercase text-base">Southern Educational Institute</a>
        <ul class="ml-auto d-flex align-items-center list-unstyled mb-0">
          ...
          <li class="sidebar-list-item"><a href="login1.html" class="sidebar-link text-muted"><i class="o-exit-1 mr-3 text-gray"></i><span>Login</span></a></li>
  ...
  <!--         <li class="nav-item dropdown mr-3"><a id="notifications" href="http://example.com" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle text-gray-400 px-1"><i class="fa fa-bell"></i><span class="notification-icon"></span></a>
    ...
    <div class="d-flex align-items-stretch">
      <div id="sidebar" class="sidebar py-3">
        ...
        <ul class="sidebar-menu list-unstyled">
              ...
              <li class="sidebar-list-item"><a href="charts.html" class="sidebar-link text-muted"><i class="o-sales-up-1 mr-3 text-gray"></i><span>News Feed</span></a></li>
              <li class="sidebar-list-item"><a href="tables.html" class="sidebar-link text-muted"><i class="o-table-content-1 mr-3 text-gray"></i><span>Teachers</span></a></li>
              <!-- <li class="sidebar-list-item"><a href="forms.html" class="sidebar-link text-muted"><i class="o-survey-1 mr-3 text-gray"></i><span></span></a></li> -->
          <li class="sidebar-list-item"><a href="#" data-toggle="collapse" data-target="#pages" aria-expanded="false" aria-controls="pages" class="sidebar-link text-muted"><i class="o-wireframe-1 mr-3 text-gray"></i><span>Class Schedule</span></a>
            <div id="pages" class="collapse">
              <ul class="sidebar-menu list-unstyled border-left border-primary border-thick">
                <li class="sidebar-list-item"><a href="#" class="sidebar-link text-muted pl-lg-5">Grade 6 to 9</a></li>
                <li class="sidebar-list-item"><a href="#" class="sidebar-link text-muted pl-lg-5">Ordinary Level</a></li>
                <li class="sidebar-list-item"><a href="#" class="sidebar-link text-muted pl-lg-5">Advanced Level</a></li>
              ...
              <div class="col-xl-3 col-lg-6 mb-4 mb-xl-0">
                <div class="bg-white shadow roundy p-4 h-100 d-flex align-items-center justify-content-between">
                  <div class="flex-grow-1 d-flex align-items-center">
                    ...
                    <div class="text">
                      <h6 class="mb-0">About Us</h6><span class="text-gray"></span>
                    </div>
                  </div>
              ...
              <div class="col-xl-3 col-lg-6 mb-4 mb-xl-0">
                <div class="bg-white shadow roundy p-4 h-100 d-flex align-items-center justify-content-between">
                  <div class="flex-grow-1 d-flex align-items-center">
                    ...
                    <div class="text">
                      <h6 class="mb-0">Contact Us</h6><span class="text-gray"></span>
                    </div>
                  </div>
    ...
    <script src="assets1/vendor/popper.js/umd/popper.min.js"> </script>
    <script src="assets1/vendor/bootstrap/js/bootstrap.min.js"></script>
    <script src="assets1/vendor/jquery.cookie/jquery.cookie.js"> </script>
    <script src="assets1/vendor/chart.js/Chart.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/js-cookie@2/src/js.cookie.min.js"></script>
    <script src="assets1/js/charts-home.js"></script>
